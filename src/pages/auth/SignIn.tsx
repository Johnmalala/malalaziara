  ...
  useEffect(() => {
    const fetchSettings = async () => {
      try {
        ...
        console.error("Failed to fetch site settings for sign-in page", err);
      }
    };
    fetchSettings();
  }, []);
    ...
    <div className="min-h-screen flex">
        ...
        >
          <div>
            ...
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
              Sign in to your account to continue your East African adventure
            </p>
          </div>
      ...
      <div className="hidden lg:block lg:flex-1">
        <div 
          ...
          style={{
            backgroundImage: `url(${settings?.signin_image_url || 'https://images.unsplash.com/photo-1564760055775-d63b17a55c44?w=800&h=1000&fit=crop'})`
          }}
        >
          <div className="absolute inset-0 bg-black bg-opacity-40" />
          <div className="absolute bottom-8 left-8 text-white">
            <h3 className="text-2xl font-bold mb-2">Welcome to East Africa</h3>
